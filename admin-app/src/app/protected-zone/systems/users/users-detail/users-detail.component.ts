...
export class UsersDetailComponent implements OnInit {
    ...
    validation_messages = {
        ...
        password: [
            { type: 'required', message: 'Bạn phải mật khẩu tài khoản' },
    ...
    ngOnInit() {
        this.entityForm = this.fb.group({
            id: [''],
            firstName: ['', [Validators.required, Validators.maxLength(255), Validators.minLength(3)]],
            lastName: ['', [Validators.required, Validators.maxLength(255), Validators.minLength(3)]],
            userName: ['', [Validators.required, Validators.maxLength(255), Validators.minLength(3)]],
            password: [
                '',
                [
                    Validators.required,
